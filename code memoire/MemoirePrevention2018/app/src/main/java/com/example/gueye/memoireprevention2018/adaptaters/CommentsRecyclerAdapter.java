...
public class CommentsRecyclerAdapter extends RecyclerView.Adapter<CommentsRecyclerAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setCommentMessage(String message) {
            commentDate = mView.findViewById(R.id.tv_comment_user);
            commentDate.setText(message);

        }
        public void setDate(String date) {
            comment_message = mView.findViewById(R.id.tv_comment_date_user);
            comment_message.setText(date);

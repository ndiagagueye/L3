...
import com.example.gueye.memoireprevention2018.activities.SendMessageActivity;
...
public class UsersRecyclerAdapter extends RecyclerView.Adapter<UsersRecyclerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        String telephone = usersList.get( position ).getTelephone();
        holder.user_call_view.setText( telephone );
        ...
        holder.mView.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                sendIntent.putExtra("token_id", token_id);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView user_call_view;
        private TextView user_token_view;
        public ViewHolder(View itemView) {
            ...
            user_call_view = mView.findViewById(R.id.user_list_call);
           // user_token_view =mView.findViewById( R.id.user_list_token );
        }
    }
}

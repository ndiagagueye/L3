...
public class SendAlerteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToolbar = findViewById(R.id.send_alert_toolbar);
        setSupportActionBar(mToolbar);
        getSupportActionBar().setTitle("Alertés");
        ...
        btnSendAlert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!TextUtils.isEmpty(etdescriptionPostAlert.getText().toString()) ){
                    ...
                    Toast.makeText( SendAlerteActivity.this, "Veuilez saisir la description", Toast.LENGTH_SHORT ).show();
                }
    ...
    public void showDialogPicker(){
        /*Button btn = findViewById( R.id.date_picker );
